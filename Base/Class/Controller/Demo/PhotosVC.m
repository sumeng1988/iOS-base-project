...
- (void)viewDidLoad {
    ...
    _images = @[[UIImage imageNamed:@"emoji_aiai_m"],
                        [UIImage imageNamed:@"emoji_anwei_m"],
                        [UIImage imageNamed:@"emoji_baobao_m"]];
    ...
    NSArray *thumbs = @[[UIImage imageNamed:@"emoji_aiai_s"],
                [UIImage imageNamed:@"emoji_anwei_s"],
                [UIImage imageNamed:@"emoji_baobao_s"]];
    
    UIImageView *image1View = [[UIImageView alloc] initWithImage:thumbs[0]];
    image1View.frame = CGRectMake(10, 100, 80, 80);
    image1View.userInteractionEnabled = YES;
    [self.view addSubview:image1View];
    
    UIImageView *image2View = [[UIImageView alloc] initWithImage:thumbs[1]];
    image2View.frame = CGRectMake(110, 100, 80, 80);
    image2View.userInteractionEnabled = YES;
    [self.view addSubview:image2View];
    
    UIImageView *image3View = [[UIImageView alloc] initWithImage:thumbs[2]];
